...
runs, assertions, AWS and OAuth2 auth, Gherkin features, JSON output, curl export, OpenAPI import and an MCP server,
...
| [Testing with Gherkin](testing.md) | You want `.feature` files to describe API behaviour and run without a Cucumber runtime. |
